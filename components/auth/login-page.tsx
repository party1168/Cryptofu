        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="請輸入您的密碼"
                  className="pl-10 pr-10 bg-[#f5f4fa] border-0 rounded-lg h-12"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                className="text-sm text-[#6c5ce7] hover:text-[#5d4ed6]"
              >
                忘記密碼？
              </button>
            </div>
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#6c5ce7] hover:bg-[#5d4ed6] h-12 rounded-lg font-medium"
            >
              {isLoading ? "登入中..." : "登入"}
            </Button>
          </form>
